...
namespace SaleApi.Services
{
    public class DonerService : IDonerService
    {
        ...
        //GetDonerByName
        public async Task<IEnumerable<UpdateDonerDto>> GetDonerByName(string name)
        {
            var d = await _donerRepository.GetDonerByName(name);
            var donors = d.Select(d => new UpdateDonerDto
            {
                Id = d.Id,
                FirstName = d.FirstName,
                LastName = d.LastName,
        ...
        //GetDonerByEmail
        public async Task<IEnumerable<UpdateDonerDto>> GetDonerByMail(string email)
        {
        ...
        public async Task<IEnumerable<GetDonerDtoWithGift>> GetDonerByGift(string giftName)
        {
            ...
            var donors = d.Select(d => new GetDonerDtoWithGift
            {
                Id = d.Id,
                FirstName = d.FirstName,
                LastName = d.LastName,
                EMail = d.Email,
                Gifts = d.Gifts
                .Where(g=>g.Name.StartsWith(giftName))
